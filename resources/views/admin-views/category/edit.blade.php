                            ...
                            <div class="col-6">
                                @foreach(json_decode($language) as $lang)
                                    ...
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                        ...
                                        <input type="text" name="name[]" value="{{$lang==$default_lang?$category['name']:($translate[$lang]['name']??'')}}" class="form-control" placeholder="{{\App\CentralLogics\translate('New category')}}" {{$lang == $default_lang? 'required':''}}>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label class="input-label" for="exampleFormControlInput1">{{\App\CentralLogics\translate('name')}} ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" value="{{$category['name']}}" class="form-control" placeholder="{{\App\CentralLogics\translate('New category')}}" required>
                                            </div>
